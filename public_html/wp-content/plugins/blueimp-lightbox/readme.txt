...
* Added compatibility information for Wordpress 4.0.
= 1.1.1 =
* Fixed automatic support for links to media files with query parameters.
= 1.1.0 =
* Fixed various issues with video galleries and fullscreen support.
* Enabled automatic support for the default Wordpress galleries.
= 1.0.1 =
